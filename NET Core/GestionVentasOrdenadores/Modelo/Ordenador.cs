...
namespace GestionVentasOrdenadores.Modelo
{
    ...
    public class DecoradorDiscoSolido : Ordenador
    {
        ...
        public DecoradorDiscoSolido(Ordenador ordenador) : base(ordenador.precio + 100, ordenador.ram, ordenador.almacenamiento * 2)
        {
            this.ordenador = ordenador;
        }
    ...
    public class DecoradorAVersiCuela : Ordenador
    {
        ...
        public DecoradorAVersiCuela(Ordenador ordenador) : base(ordenador.precio * 2, ordenador.ram, ordenador.almacenamiento)
        {
            this.ordenador = ordenador;
        }
